...
public class OI {
	...
	public static Joystick LJoystick = new Joystick(0), RJoystick = new Joystick(0);
	
	Button fireActuator = new JoystickButton(null, 0),
			collectorSpinup = new JoystickButton(null, 0),
	...
	public OI(){
		...
		collectorSpinup.whenReleased(new SpinUpCollector(0, false));//if release buttons. stop spinup.
