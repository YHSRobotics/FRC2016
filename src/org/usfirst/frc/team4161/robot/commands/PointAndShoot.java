...
public class PointAndShoot extends CommandGroup {
	...
	private static double defenseOffset[] = { -11.1, -6.66, -2.22, 2.22, 6.66 }, towerDistance = 191.5,
			desiredDistance = 5, desiredAngle = 25;

	/**
	 * Navigate to and shoot at the tower from the startDefense.
	 * 
	 * @param startDefense
	 *            The defense the robot is currently past.
	 */
	public PointAndShoot(int startDefense) {
		...
		System.out.println("PointAndShoot: Must turn " + angle + " degrees and drive " + distance
